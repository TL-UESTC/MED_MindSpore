...
def main(temp):
    ...
    for set_name in sets:
        ...
        fig_cut = 'fig_' + temp + set_name + '_pseudo_cut.jpg'
        fig = 'fig_' + temp + set_name + '_pseudo.jpg'
        for i,split_set in enumerate(sets_list):
            fig_split = 'fig_' + dataset + "_" + temp + set_name + '_pseudo_split_' + str(i+1) + '.jpg'
            plt.figure()
            ...
            file = data_path + temp + '/' + temp + 'degC_' + set_name + '_pseudo_' + str(i+1) + '_LG.mat'
            ah = y_predict_split
            ah = ah.reshape(-1,1)
